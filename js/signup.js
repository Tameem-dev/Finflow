...
// ========== SIGNUP FORM FUNCTIONALITY (YOUR ORIGINAL CODE FIXED) ==========
// Get all elements
...
// Handle form submission (FIXED - removed duplicate localStorage calls)
if (formWrapper) {
    formWrapper.addEventListener("submit", (e) => {
        ...
        if (passwordValue.length < 6) {
            Swal.fire({ icon: "error", title: "Weak", text: "Password must be 6+ characters" });
            return;
        }
...
console.log("Signup page loaded with Three.js and Glass Morphism!");